...
class LockAopAspectTest {
    ...
    public void lockAndUnlock() throws Throwable {
        //given
        ArgumentCaptor<String> lockArgumentCaptor = ArgumentCaptor.forClass(
            String.class);
        ArgumentCaptor<String> unlockArgumentCaptor = ArgumentCaptor.forClass(
            String.class);
        UseBalance.Request request = new Request(123L, "1234", 1000L);
    ...
    public void lockAndUnlock_evenIfThrow() throws Throwable {
        ...
        ArgumentCaptor<String> unlockArgumentCaptor = ArgumentCaptor.forClass(
            String.class);
        UseBalance.Request request = new Request(123L, "54321", 1000L);
